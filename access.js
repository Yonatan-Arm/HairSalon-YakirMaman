...
(MicAccessTool.prototype.checkLanguageBox = function () {
  ...
  (MicAccessTool.prototype.buildToolBox = function () {
    var A = this.currentLanguage || this.locale.en,
      o =
        '<button title="' +
        A.btn_open +
        '" tabindex="1" id="mic-access-tool-general-button" class="mic-access-tool-general-button"><div><img src="data:image/png;base64," alt="' +
        A.btn_open +
  ...
  (MicAccessTool.prototype.contrastChange = function (A) {
    if ((A.preventDefault(), document.body.classList.contains(this.id)))
      ...
      for (
        var o = document.querySelectorAll('.mic-contrast-block button'), t = 0;
        t < o.length;
        t++
      )
  ...
  (MicAccessTool.prototype.initFontsChange = function () {
    for (
      var A = document.querySelectorAll(
        ...
        o = window.MICTOOLBOXAPPSTATE.fontSize,
        t = 0;
      t < A.length;
      t++
    ) {
  ...
  (MicAccessTool.prototype.imagesChange = function () {
    if (document.body.classList.contains('mic-toolbox-content-images')) {
      for (
        var A = document.querySelectorAll('.mic-toolbox-images-titles'), o = 0;
        o < A.length;
        o++
      ) {
  ...
  (MicAccessTool.prototype.updateState = function () {
    ...
    'undefined' != typeof Storage
      ? localStorage.setItem('MICTOOLBOXAPPSTATE', A)
